...
today = 'woke up', 'ate breakfast', 'went to the gym', 'prepped for lecture', 'ate lunch', 'grdaed', 'meetings', 'in class'

# enumerates() : returns a tuple of each item and its index

for task in enumerate(today): # each task returned to us individually tuplrs with their indecies
    print(task)
    print(task[1])
